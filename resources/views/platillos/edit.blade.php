                    ...
                    <script>
                        document.addEventListener('DOMContentLoaded', function() {
                            ...
                            function addRow(selectedId = '', cantidad = '') {
                                ...
                                row.innerHTML = `
                                    ${selectHtml}
                                    <input type="number" step="0.01" min="0.01" name="ingredientes[cantidad][]" value="${cantidad}" class="form-input" placeholder="Cantidad para 100 porciones" style="flex: 1;" required>
