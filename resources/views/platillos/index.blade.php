...
<body>
        ...
        <div class="top-nav" style="align-items: flex-start; margin-bottom: 2rem; padding-bottom: 0;">
            ...
            <header class="dashboard-header" style="margin: 3rem 0 0 0; flex: 2; display: flex; flex-direction: column; justify-content: center; max-width: none;">
                <hgroup>
                    ...
                    <h1 class="dashboard-title" style="font-size: 2.5rem; margin-top: 0.2rem;">Platillos</h1>
                    <p class="dashboard-description" style="margin: 0.5rem auto 0; font-size: 1.05rem;">Gestiona el catálogo de platillos, categorías e ingredientes para crear menús personalizados para tus eventos.</p>
                </hgroup>
            </header>
            ...
            <menu class="action-bar" aria-label="Acciones del catálogo">
                ...
                <li>
                    <nav class="action-controls" aria-label="Controles del listado">
                        <!-- Búsqueda -->
                        <input type="text" id="search-input" class="search-bar-input" placeholder="Buscar platillo...">
    ...
    <script>
        ...
        function confirmDelete(name, formId) {
            ...
            textEl.innerHTML = `¿Estás seguro de que deseas eliminar permanentemente el platillo <strong>"${name}"</strong>? Esta acción puede afectar contratos o cotizaciones activas.`;
            modal.showModal();
        }
        ...
        listViewBtn.addEventListener('click', () => {
            ...
            localStorage.setItem('platillos_view', 'list');
        });

        // Restaurar preferencia
        const savedView = localStorage.getItem('platillos_view');
