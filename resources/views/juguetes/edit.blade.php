...
<head>
    ...
    <title>Editar Juguete · FantaSync</title>
...
<body>
    ...
    <main class="dashboard-layout">
        <section class="top-nav" style="align-items: flex-start; margin-bottom: 2rem; padding-bottom: 0;">
            ...
            <header class="dashboard-header" style="margin: 2rem 0 0 0; flex: 2; display: flex; flex-direction: column; justify-content: center; max-width: none;">
                <hgroup>
                    ...
                    <h1 class="dashboard-title" style="font-size: 2.8rem; margin-top: 0.2rem;">Editar Juguete</h1>
                    <p class="dashboard-description" style="margin: 0.5rem auto 0; font-size: 1.1rem;">Modifica los detalles o ajusta el stock actual del juguete.</p>
                </hgroup>
            </header>
        ...
        <section class="eventos-section" style="margin-top: 8.5rem;">
            <form action="{{ route('juguetes.update', $juguete) }}" method="POST" class="nomina-form-container" style="max-width: 600px;">
                @csrf
                @method('PUT')
                <fieldset class="form-group border-0 p-0 m-0 form-fieldset-lg">
                    ...
                    <input type="text" name="nombre" value="{{ old('nombre', $juguete->nombre) }}" class="form-control" required>
                ...
                <fieldset class="form-group border-0 p-0 m-0 form-fieldset-lg">
                    ...
                    <input type="text" name="descripcion" value="{{ old('descripcion', $juguete->descripcion) }}" class="form-control">
                ...
                <section class="form-flex-row">
                    <fieldset class="form-group border-0 p-0 m-0 form-fieldset-flex">
                        <label class="form-label form-label-semibold">Stock Actual</label>
                        <input type="number" name="stock_actual" value="{{ old('stock_actual', $juguete->stock_actual) }}" min="0" class="form-control" required>
                    ...
                    <fieldset class="form-group border-0 p-0 m-0 form-fieldset-flex">
                        ...
                        <input type="number" name="stock_minimo" value="{{ old('stock_minimo', $juguete->stock_minimo) }}" min="0" class="form-control" required>
                        @error('stock_minimo') <span class="form-error-msg">{{ $message }}</span> @enderror
                    </fieldset>
                </section>

                <section class="pt-4">
                    <button type="submit" class="button-submit btn-submit-full">Guardar Cambios</button>
                </section>
            </form>
        </section>
    </main>
