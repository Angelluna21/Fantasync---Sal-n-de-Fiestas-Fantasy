...
<head>
    ...
    <title>Dar de Alta Nómina · FantaSync</title>
...
<body>
        ...
        <section class="top-nav" style="align-items: flex-start; margin-bottom: 2rem; padding-bottom: 0;">
            ...
            <header class="dashboard-header" style="margin: 2rem 0 0 0; flex: 2; display: flex; flex-direction: column; justify-content: center; max-width: none;">
                <hgroup>
                    ...
                    <h1 class="dashboard-title" style="font-size: 2.8rem; margin-top: 0.2rem;">Alta de Recibo (Nómina)</h1>
                    <p class="dashboard-description" style="margin: 0.5rem auto 0; font-size: 1.1rem;">Registra múltiples días o turnos de trabajo para un mismo empleado.</p>
                </hgroup>
            </header>
            ...
            <form action="{{ route('nominas.store') }}" method="POST" class="nomina-form-container">
                ...
                <section class="form-flex-row" style="margin-top: 2rem;">
                    ...
                    <fieldset class="form-group border-0 p-0 m-0 form-fieldset-flex">
                        ...
                        <input type="number" step="0.01" name="monto_total" id="monto_total_general" class="form-control form-input-total" style="font-size: 1.5rem; height: auto; padding: 0.75rem;" readonly>
                    </fieldset>
                </section>
                
                <section class="pt-4">
                    <button type="submit" class="button-submit btn-submit-full">Guardar Recibo de Nómina</button>
                </section>
            </form>
        </section>
    </main>
    ...
    <script>
        ...
        // Filtrado global de eventos solo afecta nuevas selecciones
        // Empezamos con un día vacío por defecto
        addDiaRow();
