...
<body>
    ...
    <main class="dashboard-layout">
        <!-- Navegación superior: Logo (como botón) y Cerrar sesión a la derecha -->
        <nav class="top-nav" aria-label="Menú superior">
            
            <!-- ENLACE DEL LOGO: Al hacer clic regresa al inicio -->
        ...
        <section class="dashboard-actions" aria-label="Secciones de administración del panel">
            ...
            <article class="dashboard-card">
                <span class="card-icon" aria-hidden="true">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2v10z"></path></svg>
                </span>
                <h2>Platillos</h2>
