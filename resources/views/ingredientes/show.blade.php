...
<body>
    ...
    <main class="dashboard-layout">
        ...
        <div class="top-nav" style="align-items: flex-start; margin-bottom: 2rem; padding-bottom: 0;">
            ...
            <header class="dashboard-header" style="margin: 3rem 0 0 0; flex: 2; display: flex; flex-direction: column; justify-content: center; max-width: none;">
                <hgroup>
                    ...
                    <h1 class="dashboard-title" style="font-size: 2.5rem; margin-top: 0.2rem;">{{ $ingrediente->nombre }}</h1>
                    <p class="dashboard-description" style="margin: 0.5rem auto 0; font-size: 1.05rem;">Detalles del insumo y listado de preparaciones culinarias que lo requieren.</p>
                </hgroup>
            </header>
        ...
        <section aria-label="Ficha de detalles del ingrediente" style="margin-top: 7rem;">
