...
<head>
    ...
    <title>Editar Salón · FantaSync</title>
    ...
    <main class="dashboard-layout">
        ...
        <header class="dashboard-header">
            <hgroup>
                ...
                <h1 class="dashboard-title">Editar Salón</h1>
                <p class="dashboard-description">Modifica la información del salón o espacio disponible para eventos.</p>
            </hgroup>
        </header>

        <!-- Formulario -->
        <section class="form-section" aria-label="Formulario de edición de salón">
            <section class="form-container">
                ...
                <form method="POST" action="{{ route('salones.update', $salon->id) }}" class="form-card">
                    @csrf
                    @method('PUT')
