    ...
    <main class="dashboard-layout">
        ...
        <header class="dashboard-header">
            <hgroup>
                ...
                <h1 class="dashboard-title">Servicios Gastronómicos</h1>
                <p class="dashboard-description">Gestiona los tipos de servicio (ej. Menús a 2 Tiempos, Taquizas) que puedes ofrecer en tus eventos.</p>
            </hgroup>
        </header>
        ...
        <section class="platillos-section" aria-label="Listado de servicios gastronómicos">
