...
class StoreContratoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'detalle_pinata' => 'nullable|string|max:255',
            'tiene_cafe' => 'nullable|boolean',
            'tiene_show' => 'nullable|boolean',
            'detalle_show' => 'nullable|string|max:150',
            'arco_globos' => 'nullable|boolean',
            'derecho_pista_check' => 'nullable|boolean',
