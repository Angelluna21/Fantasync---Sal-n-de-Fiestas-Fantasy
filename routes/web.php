...
Route::middleware('auth')->group(function () {
    ...
    // Módulo de Contratos
    Route::get('contratos/demo/{id}', [ContratoController::class, 'show'])->name('contrato.demo');
    Route::resource('contratos', ContratoController::class)->except(['create', 'store', 'update']);
